...
containerElement.style.backgroundColor = "lightGreen";
...
const domMethodElements = document.getElementsByClassName("dom-methods");
for (let i = 0; i < domMethodElements.length; i++) {
  domMethodElements[i].style.color = "blue";
}
...
const domMethodElementsQuery = document.querySelectorAll(".dom-methods");
for (let i = 0; i < domMethodElementsQuery.length; i++) {
  domMethodElementsQuery[i].style.fontSize = "20px";
}
